    ...
    <div class="info-data">
        <div class="card">
            <div class="head">
                ...
                <!-- CONTENT -->
                <a href="<?= base_url(); ?>resident/add3" class="btn btn-primary ms-auto mb-3"><i class='bx bx-plus me-2'></i>Add Resident</a>
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#residentTable').DataTable({
            "ajax": {
                "url": "<?= site_url('/resident/getResidentData3') ?>",
                "type": "GET",
                        ...
                        var btn = `
                            <div class='btn-group' role='group'>
                                ...
                                <ul class='dropdown-menu'>
                                    <li>
                                        <a class='dropdown-item' href='${baseUrl}resident/edit_household3/${id}' role='button'>
                                            <span class='icon-text'>Update details</span>
                                        </a>
                                    </li>
                                     <li>
                                        <a class='dropdown-item' href='${baseUrl}resident/view_form3/${household}' role='button'>

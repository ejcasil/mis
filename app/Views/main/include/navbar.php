 ...
 <nav>
     ...
     <?php if ((isset($online_request['household_request']) && $online_request['household_request'] !== "0") || (isset($online_request['user_request']) && $online_request['user_request'] !== "0")) : ?>
         <li>
             <div class="dropdown">
                 ...
                 <ul class="dropdown-menu">
                     <?php if (isset($online_request['household_request']) && $online_request['household_request'] !== "0"): ?>
                         <li><a class="dropdown-item" href="<?= base_url(); ?>resident/for_approval3">Household Approval</a></li>
                     <?php endif; ?>
                     <?php if (isset($online_request['user_request']) && $online_request['user_request'] !== "0"): ?>
                         <li><a class="dropdown-item" href="<?= base_url(); ?>user_management3">User Approval</a></li>
                     <?php endif; ?>
                 </ul>
             </div>
         </li>
     ...
     <div class="profile">
         ...
         <ul class="profile-link">
             <li><a href="<?= base_url(); ?>profile/myAccount3"><i class="bx bxs-user-circle icon"></i>My Account</a></li>

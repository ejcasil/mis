        ...
        <form id="savePayment" method="POST">
          <input type="hidden" id="certification-id" name="certification-id">
            ...
            <div class="mb-2">
              ...
              <input type="text" class="form-control border-0 bg-transparent fw-bold" name="document_type_detail" id="document_type_detail" disabled>
            </div>
            <div class="mb-2">
              <label>Document Fee</label>
              <input type="text" class="form-control border-0 bg-transparent fw-bold" name="document_fee_detail" id="document_fee_detail" disabled>
            </div>

        ...
        <div class="card">
            <div class="head">
                ...
                <div class="container d-flex gap-4 flex-sm-column flex-md-column flex-lg-row flex-xl-row">
                    <img src="<?= ($profile['logo']) ? $profile['logo'] : ''; ?>" class="img-fluid p-2 border rounded shadow-sm lblLogo" style="width:200px;height:200px">
                    <div class="brgy-info w-100">
                        ...
                        <div class="row border border-light my-2 rounded shadow-sm">
                            ...
                            <div class="col-sm-12 col-md-9 col-xl-9 p-2">
                                <label class="fw-bold lblBarangay"><?= ($profile['brgy_name']) ? $profile['brgy_name'] : ''; ?></label>
                            </div>
                        </div>
                        ...
                        <div class="row border border-light my-2 rounded shadow-sm">
                            ...
                            <div class="col-sm-12 col-md-9 col-xl-9 p-2">
                                <label class="fw-bold lblMunicipality"><?= ($profile['municipality']) ? $profile['municipality'] : ''; ?></label>
                            </div>
                        </div>
                        ...
                        <div class="row border border-light my-2 rounded shadow-sm">
                            ...
                            <div class="col-sm-12 col-md-9 col-xl-9 p-2">
                                <label class="fw-bold lblProvince"><?= ($profile['province']) ? $profile['province'] : ''; ?></label>
                            </div>
                        </div>
                        ...
                        <div class="row border border-light my-2 rounded shadow-sm">
                            ...
                            <div class="col-sm-12 col-md-9 col-xl-9 p-2">
                                <label class="fw-bold lblRegion"><?= ($profile['region']) ? $profile['region'] : ''; ?></label>
                            </div>
                        </div>
                        ...
                        <div class="row border border-light my-2 rounded shadow-sm">
                            ...
                            <div class="col-sm-12 col-md-9 col-xl-9 p-2">
                                <label class="fw-bold lblOfficial"><?= ($profile['official_name']) ? $profile['official_name'] : ''; ?></label>
                            </div>
                        </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#profileForm').submit(function(e) {
            ...
            $.ajax({
                url: "<?= site_url('/brgy_profile/saveProfile3') ?>",
                type: "POST",
                data: formData,
        ...
        $(document).on('click', '#updateProfile', function() {
            ...
            $.ajax({
                url: "<?= site_url('/brgy_profile/getProfile3') ?>",
                type: "GET",
                success: function(response) {
                    if (response.success) {
                        let data = response.data;

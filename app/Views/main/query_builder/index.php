                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col">
                                        ...
                                        <select class="form-select" name="purok" id="purok">
                                            <option value="" selected>Select option</option>
                                            <!-- INITIALLY REMOVED LIST OF PUROKS HERE -->    
                                        </select>
                                    </div>
                                    <div class="col">
...
<script>
    $(document).ready(function() {
        ...
        function fetchPurokList(brgy_id) {
            $.ajax({
                url: "<?= site_url('/query_builder/fetchPurokList/') ?>" + brgy_id,
                method: "GET",
        ...
        $(document).on("click", "#btnExport", function() {
            ...
            $.ajax({
                url: "<?= site_url('/query_builder/export_data3') ?>", // Send data to the server
                type: "POST",
                data: {
        ...
        $("#messageForm").submit(function(e) {
            ...
            $.ajax({
                url: "<?= site_url('/query_builder/sendMessage3') ?>", // Send data to the server
                type: "POST",
                data: {
        ...
        var myTable = $('#table_query').DataTable({
            "ajax": {
                "url": "<?= site_url('/query_builder/getDefaultData3') ?>",
                "type": "GET",
        ...
        $("#filterRecordForm").submit(function(e) {
            ...
            $.ajax({
                url: "<?= site_url('/query_builder/filter3') ?>",
                type: "POST",
                data: formData,
                success: function(response) {

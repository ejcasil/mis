...
<script>
    $(document).ready(function() {
        ...
        var userTable = $('#userTable').DataTable({
            "ajax": {
                "url": "<?= site_url('/user_management/getUserData') ?>",
                "type": "GET",
                        ...
                        if (status && status == "PENDING") {
                            ...
                            <div class='btn-group' role='group'>
                                ...
                                <ul class='dropdown-menu'>
                                    <li>
                                        <a class='dropdown-item' href='${baseUrl}user_management/approve/${id}' role='button'>
                                            </i><span class='icon-text'>Approve</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a class='dropdown-item' href='${baseUrl}user_management/decline/${id}' role='button'>
        ...
        $('#userForm').submit(function(e) {
            ...
            $.ajax({
                url: "<?= site_url('/user_management/saveUser') ?>",
                type: "POST",
                data: formData,
